...
<p><img src="@source/zh/课程实验/单片机实验/stm32.assets/image-20220615210549497.png" alt="image-20220615210549497" loading="lazy"></p>
<p>其中<strong>PSC</strong>处是配置分频系数，<strong>Counter Period</strong>处是配置定时器的计数上限值，当达到该上限值时执行中断服务函数。</p>
<p><img src="@source/zh/课程实验/单片机实验/stm32.assets/image-20220615211242128.png" alt="image-20220615211242128" loading="lazy"></p>
<p>配置为定时器更新时触发中断。别忘了配置时钟源为内部时钟。</p>
<p>使能定时器相应的中断：</p>
<p><img src="@source/zh/课程实验/单片机实验/stm32.assets/image-20220615211431885.png" alt="image-20220615211431885" loading="lazy"></p>
