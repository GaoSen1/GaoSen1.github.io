...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604113216012.png" alt="image-20220604113216012" loading="lazy"></p>
<p>点击链接，查看项目运行地址：<img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604113354706.png" alt="image-20220604113354706" loading="lazy"></p>
<p>可以看到用户界面初始渲染了样例输入的波形</p>
<p>现在A输入0001000100010001，在B输入0101010101010101，结果显示:</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604130304737.png" alt="image-20220604130304737" loading="lazy"></p>
<p>点击上方按钮，把其他波形隐藏，只观测异或波形：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604130430763.png" alt="image-20220604130430763" loading="lazy"></p>
</li>
<li>
<p>设计过程中出现的错误。</p>
<ol>
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604193609677.png" alt="image-20220604193609677" loading="lazy"></p>
<p>完成一个程序，实现如下功能
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604220857738.png" alt="image-20220604220857738" loading="lazy"></p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604220916911.png" alt="image-20220604220916911" loading="lazy"></p>
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604221345851.png" alt="image-20220604221345851" loading="lazy"></p>
<p>点击链接，查看项目运行地址</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220604221436067.png" alt="image-20220604221436067" loading="lazy"></p>
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605183642963.png" alt="image-20220605183642963" loading="lazy"></p>
<p>项目运行结果：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605200926790.png" alt="image-20220605200926790" loading="lazy"></p>
<p>点击链接查看项目运行地址：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201008044.png" alt="image-20220605201008044" loading="lazy"></p>
<p>点击开奖：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201050205.png" alt="image-20220605201050205" loading="lazy"></p>
<p>点击单抽或五连抽，会有类似大转盘的抽奖动画：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201130956.png" alt="image-20220605201130956" loading="lazy"></p>
<p>抽完五个数后，会显示用户手中的号码数：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201228520.png" alt="image-20220605201228520" loading="lazy"></p>
<p>点击兑奖，会给出用户的获奖等级：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201320740.png" alt="image-20220605201320740" loading="lazy"></p>
<p>再次点击开奖，会有提示信息：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201407280.png" alt="image-20220605201407280" loading="lazy"></p>
<p>再次点击抽奖，也会有提示信息：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201437751.png" alt="image-20220605201437751" loading="lazy"></p>
<p>可以在“作弊”输入框输入想要的号码：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605201553452.png" alt="image-20220605201553452" loading="lazy"></p>
<ul>
<li>由于该题较为简单，所以设计过程中基本没有出现什么错误。</li>
</ul>
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605213010267.png" alt="image-20220605213010267" loading="lazy"></p>
...
<li>
<p>rnbakabnr表示</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605222447238.png" alt="image-20220605222447238" loading="lazy"></p>
</li>
<li>
<p>9表示：第二行都是空格。</p>
</li>
...
<p>假设有一张棋盘如下：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605222656149.png" alt="image-20220605222656149" loading="lazy"></p>
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605225358012.png" alt="image-20220605225358012" loading="lazy"></p>
...
<p><strong>将</strong></p>
<p>将的走法有四个方向，如下图所示：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605225910517.png" alt="image-20220605225910517" loading="lazy"></p>
...
<p><strong>士</strong></p>
<p>士的走法也是四个方向，如下所示:</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605230051257.png" alt="image-20220605230051257" loading="lazy"></p>
<p>士的4个方向分别满足以下等式：</p>
...
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605231838669.png" alt="image-20220605231838669" loading="lazy"></p>
<p>点击链接，查看项目运行地址：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605231908645.png" alt="image-20220605231908645" loading="lazy"></p>
<p>默认为玩家对战模式，尝试走棋，若走棋合法则该棋移动，走棋方切换；若不合法则不移动也不切换。</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232038825.png" alt="image-20220605232038825" loading="lazy"></p>
<p>鼠标悬浮在人机对战按钮上，会提示被动技能相关信息：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232209053.png" alt="image-20220605232209053" loading="lazy"></p>
<p>点击人机对战后：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232310274.png" alt="image-20220605232310274" loading="lazy"></p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232314472.png" alt="image-20220605232314472" loading="lazy"></p>
<p>电脑走棋时会给用户提示电脑移动了哪步棋：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232518947.png" alt="image-20220605232518947" loading="lazy"></p>
<p>触发替父从军：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232642449.png" alt="image-20220605232642449" loading="lazy"></p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232655918.png" alt="image-20220605232655918" loading="lazy"></p>
<p>触发兵线刷新：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232758291.png" alt="image-20220605232758291" loading="lazy"></p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232808275.png" alt="image-20220605232808275" loading="lazy"></p>
<p>触发草木皆兵：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232926165.png" alt="image-20220605232926165" loading="lazy"></p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232937020.png" alt="image-20220605232937020" loading="lazy"></p>
<p>一方胜利后会有评分结算：</p>
<p><img src="@source/zh/课程实验/专业实验/实验报告.assets/image-20220605232433106.png" alt="image-20220605232433106" loading="lazy"></p>
</li>
<li>
<p>设计过程中出现的错误。</p>
</li>
...
<p>本次实验遇到最大的困难是电脑走棋的搜索算法，由于棋子很多，而且存储棋盘的数组的长度高达256，算法的时间复杂度甚至在 <mjx-container class="MathJax" jax="SVG"><svg style="vertical-align: -0.452ex;" xmlns="http://www.w3.org/2000/svg" width="8.596ex" height="2.357ex" role="img" focusable="false" viewBox="0 -841.7 3799.6 1041.7"><g stroke="currentColor" fill="currentColor" stroke-width="0" transform="scale(1,-1)"><g data-mml-node="math"><g data-mml-node="mi"><path data-c="1D442" d="M740 435Q740 320 676 213T511 42T304 -22Q207 -22 138 35T51 201Q50 209 50 244Q50 346 98 438T227 601Q351 704 476 704Q514 704 524 703Q621 689 680 617T740 435ZM637 476Q637 565 591 615T476 665Q396 665 322 605Q242 542 200 428T157 216Q157 126 200 73T314 19Q404 19 485 98T608 313Q637 408 637 476Z"></path></g><g data-mml-node="mi" transform="translate(763,0)"><text data-variant="italic" transform="scale(1,-1)" font-size="884px" font-family="serif" font-style="italic">（</text></g><g data-mml-node="msup" transform="translate(1763,0)"><g data-mml-node="mi"><path data-c="1D45B" d="M21 287Q22 293 24 303T36 341T56 388T89 425T135 442Q171 442 195 424T225 390T231 369Q231 367 232 367L243 378Q304 442 382 442Q436 442 469 415T503 336T465 179T427 52Q427 26 444 26Q450 26 453 27Q482 32 505 65T540 145Q542 153 560 153Q580 153 580 145Q580 144 576 130Q568 101 554 73T508 17T439 -10Q392 -10 371 17T350 73Q350 92 386 193T423 345Q423 404 379 404H374Q288 404 229 303L222 291L189 157Q156 26 151 16Q138 -11 108 -11Q95 -11 87 -5T76 7T74 17Q74 30 112 180T152 343Q153 348 153 366Q153 405 129 405Q91 405 66 305Q60 285 60 284Q58 278 41 278H27Q21 284 21 287Z"></path></g><g data-mml-node="mn" transform="translate(633,363) scale(0.707)"><path data-c="34" d="M462 0Q444 3 333 3Q217 3 199 0H190V46H221Q241 46 248 46T265 48T279 53T286 61Q287 63 287 115V165H28V211L179 442Q332 674 334 675Q336 677 355 677H373L379 671V211H471V165H379V114Q379 73 379 66T385 54Q393 47 442 46H471V0H462ZM293 211V545L74 212L183 211H293Z"></path></g></g><g data-mml-node="mi" transform="translate(2799.6,0)"><text data-variant="italic" transform="scale(1,-1)" font-size="884px" font-family="serif" font-style="italic">）</text></g></g></g></svg></mjx-container> 左右，一旦出现bug将很难定位该bug出现在哪步，有时修改到深夜一两点钟仍无果。解决方法是debug时先不遍历整个棋盘，而是棋盘的前10个（左右）的棋子，将流程图与伪代码放在旁边，时刻提示自己算法步骤。</p>
