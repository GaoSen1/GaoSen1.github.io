...
<p><img src="@source/zh/课程实验/专业实验/04_chess1.assets/image-20220408134722320.png" alt="image-20220408134722320" loading="lazy"></p>
...
<p>使用整数表示棋子</p>
<p><img src="@source/zh/课程实验/专业实验/04_chess1.assets/image-20220408131211570.png" alt="image-20220408131211570" loading="lazy"></p>
<p>这样可以快速判断某棋子属于红方还是黑方，如下表所示：</p>
<p><img src="@source/zh/课程实验/专业实验/04_chess1.assets/image-20220408131248221.png" alt="image-20220408131248221" loading="lazy"></p>
<p>可以看出：</p>
<p>红方棋子 &amp; 8 = 1</p>
<p>黑方棋子 &amp; 16 = 1</p>
...
<p><img src="@source/zh/课程实验/专业实验/04_chess1.assets/image-20220408131454681.png" alt="image-20220408131454681" loading="lazy"></p>
<p>中国象棋共有十行，每行都用一个字符串表示，行间使用正斜杠分割。</p>
<p>例如：</p>
<ul>
<li>
<p>rnbakabnr表示<img src="@source/zh/课程实验/专业实验/04_chess1.assets/image-20220408132905553.png" alt="image-20220408132905553" loading="lazy"></p>
</li>
<li>
<p>9表示：第二行都是空格。</p>
</li>
...
<li>
<p>棋盘界面设计</p>
<p><img src="@source/zh/课程实验/专业实验/04_chess1.assets/image-20220408133925789.png" alt="image-20220408133925789" loading="lazy"></p>
...
<p><img src="@source/zh/课程实验/专业实验/05_chess1.assets/image-20220525214814456.png" alt="image-20220525214814456" loading="lazy"></p>
