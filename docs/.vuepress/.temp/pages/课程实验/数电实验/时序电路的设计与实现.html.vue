...
<p><img src="@source/课程实验/数电实验/assets/select.png" alt="img" loading="lazy"></p>
<ul>
<li>
...
<p><img src="@source/课程实验/数电实验/时序电路的设计与实现.assets/image-20220512214226037.png" alt="image-20220512214226037" loading="lazy"></p>
<p><img src="@source/课程实验/数电实验/时序电路的设计与实现.assets/image-20220512214259757.png" alt="image-20220512214259757" loading="lazy"></p>
<p><img src="@source/课程实验/数电实验/时序电路的设计与实现.assets/image-20220512214340140.png" alt="image-20220512214340140" loading="lazy"></p>
<p><img src="@source/课程实验/数电实验/时序电路的设计与实现.assets/image-20220512214350690.png" alt="image-20220512214350690" loading="lazy"></p>
<ul>
<li>
...
<p><img src="@source/课程实验/数电实验/时序电路的设计与实现.assets/image-20220512200422669.png" alt="image-20220512200422669" loading="lazy"></p>
<ul>
<li>
<h3 id="外观图-1" tabindex="-1"><a class="header-anchor" href="#外观图-1" aria-hidden="true">#</a> 外观图:</h3>
</li>
</ul>
<p><img src="@source/课程实验/数电实验/assets/seg.png" alt="seg" loading="lazy"></p>
<ul>
<li>
...
<p>vhdl：<img src="@source/课程实验/数电实验/assets/SEG_vhdl.png" alt="vhdl" loading="lazy"></p>
<p>vhdl编译成功：<img src="@source/课程实验/数电实验/assets/SEG_vhdl编译成功.png" alt="vhdl compile" loading="lazy"></p>
<p>波形仿真成功：<img src="@source/课程实验/数电实验/assets/SEG_波形仿真成功.png" alt="img" loading="lazy"></p>
<p>仿真波形：<img src="@source/课程实验/数电实验/时序电路的设计与实现.assets/SEG_波形仿真.png" alt="img" loading="lazy"></p>
<ul>
<li>
...
<p><img src="@source/课程实验/数电实验/assets/分频器.png" alt="分频器" loading="lazy"></p>
<ul>
<li>
...
<p><img src="@source/课程实验/数电实验/assets/计数器.png" alt="img" loading="lazy"></p>
<ul>
<li>
